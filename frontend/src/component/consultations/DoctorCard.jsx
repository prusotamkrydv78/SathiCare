...
const DoctorCard = ({ doctor, onBook }) => {
    ...
    return (
        <motion.div
            whileHover={{ y: -4 }}
            className="bg-gradient-to-br from-blue-50 to-teal-50 rounded-2xl p-5 border-2 border-blue-100 hover:border-blue-300 transition cursor-pointer"
        >
            <div className="flex items-start gap-4 mb-4">
                <div className="w-16 h-16 bg-gradient-to-br from-blue-500 to-teal-500 rounded-xl flex items-center justify-center text-3xl shadow-lg flex-shrink-0">
            ...
            <div className="flex items-center gap-2">
                ...
                <button className="px-4 py-2.5 bg-white border-2 border-blue-200 rounded-xl hover:bg-blue-50 transition">
